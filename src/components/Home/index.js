                ...
                <div className='text-zone'>
                    ...
                    <div className="social-icons">
                        <a href="https://github.com/aam3" target="_blank" rel="noopener noreferrer">
                            <FontAwesomeIcon icon={faGithub} style={{ color: "#444345", stroke: "#C0AA81", strokeWidth: 10 }} />
                        </a>
                        <a href="https://www.linkedin.com/in/alisabeth-m-21273b117/" target="_blank" rel="noopener noreferrer">
                            <FontAwesomeIcon icon={faLinkedin} style={{ color: "#444345", stroke: "#C0AA81", strokeWidth: 10 }} />
                        </a>
                    </div>
                </div>
            </div>
